...
export const ALL_PLANS: Record<PlanId, Plan> = {
  ...
  finance_coach_premium: {
    ...
    description: 'KI-Finanzberatung mit allen Features',
    role: 'kombi',
    price: 999,
    yearlyPrice: 9590,
    monthlyCredits: 30,
  ...
  biz_pro: {
    id: 'biz_pro',
    name: 'Business Pro',
    description: 'Buchhaltung und Business-Tools',
    role: 'kombi',
    price: 1499,
    yearlyPrice: 14390,
    monthlyCredits: 40,
  ...
  biz_ai_cfo: {
    id: 'biz_ai_cfo',
    name: 'KI-CFO',
    description: 'KI-gesteuerter Finanzchef fuer dein Business',
    role: 'kombi',
    price: 2999,
    yearlyPrice: 28790,
    monthlyCredits: -1,
  ...
  learn_premium: {
    id: 'learn_premium',
    name: 'Mentor Premium',
    description: 'Alle Kurse und Zertifikate',
    role: 'kombi',
    price: 699,
    yearlyPrice: 6710,
    monthlyCredits: 10,
  ...
  api_startup: {
    id: 'api_startup',
    name: 'API Startup',
    description: 'Fintutto-APIs fuer Startups',
    role: 'kombi',
    price: 4999,
    yearlyPrice: 47990,
    monthlyCredits: 100,
  ...
  api_pro: {
    id: 'api_pro',
    name: 'API Pro',
    description: 'Unbegrenzte API-Nutzung',
    role: 'kombi',
    price: 9999,
    yearlyPrice: 95990,
    monthlyCredits: -1,
  ...
  universe_bundle: {
    ...
    description: 'Alle Fintutto-Apps in einem Paket',
    role: 'kombi',
    price: 3499,
    yearlyPrice: 33590,
    monthlyCredits: -1,
