...
export const ALL_PLANS: Record<PlanId, Plan> = {
  ...
  // FinTech Universe plans
  finance_coach_premium: {
    id: 'finance_coach_premium',
    name: 'Finance Coach Premium',
    description: 'KI-Finanzberatung ohne Limits',
    price: 999,
    yearlyPrice: 9590,
    monthlyCredits: 30,
    canSave: true,
    canExportPdf: true,
    aiMessages: -1,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_FINANCE_COACH_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_FINANCE_COACH_YEARLY'),
    features: ['30 Credits pro Monat', 'Unbegrenzt KI-Nachrichten', 'Budgetplanung', 'PDF-Export'],
  },
  biz_pro: {
    id: 'biz_pro',
    name: 'Biz Pro',
    ...
    canExportPdf: true,
    aiMessages: 20,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_BIZ_PRO_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_BIZ_PRO_YEARLY'),
    features: ['20 Credits pro Monat', '20 KI-Nachrichten/Monat', 'Rechnungen & Belege', 'PDF-Export'],
  },
  biz_ai_cfo: {
    id: 'biz_ai_cfo',
    name: 'Biz AI CFO',
    description: 'KI-CFO fuer Freelancer',
    price: 2999,
    yearlyPrice: 28790,
    monthlyCredits: -1,
    canSave: true,
    canExportPdf: true,
    aiMessages: -1,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_BIZ_AI_CFO_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_BIZ_AI_CFO_YEARLY'),
    features: ['Unbegrenzte Credits', 'Unbegrenzt KI-Nachrichten', 'Vollstaendige Buchhaltung', 'PDF-Export'],
  },
  learn_premium: {
    id: 'learn_premium',
    name: 'Learn Premium',
    ...
    canExportPdf: true,
    aiMessages: 20,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_LEARN_PREMIUM_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_LEARN_PREMIUM_YEARLY'),
    features: ['20 Credits pro Monat', '20 KI-Nachrichten/Monat', 'Alle Kurse', 'Zertifikate'],
  },
  api_startup: {
    id: 'api_startup',
    name: 'API Startup',
    description: 'Finance API fuer Startups',
    price: 4900,
    yearlyPrice: 47040,
    monthlyCredits: 0,
    canSave: true,
    canExportPdf: false,
    aiMessages: 0,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_API_STARTUP_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_API_STARTUP_YEARLY'),
    features: ['1.000 API Calls/Monat', 'REST & GraphQL', 'Basic Support'],
  },
  api_pro: {
    id: 'api_pro',
    name: 'API Pro',
    description: 'Finance API fuer Unternehmen',
    price: 14900,
    yearlyPrice: 143040,
    monthlyCredits: 0,
    canSave: true,
    canExportPdf: false,
    aiMessages: 0,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_API_PRO_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_API_PRO_YEARLY'),
    features: ['10.000 API Calls/Monat', 'REST & GraphQL', 'Priority Support', 'Custom Webhooks'],
  },
  universe_bundle: {
    id: 'universe_bundle',
    name: 'Universe Bundle',
    description: 'Alles in einem Paket',
    price: 3999,
    yearlyPrice: 38390,
    monthlyCredits: -1,
    canSave: true,
    canExportPdf: true,
    aiMessages: -1,
    stripePriceIdMonthly: getEnv('VITE_STRIPE_PRICE_UNIVERSE_BUNDLE_MONTHLY'),
    stripePriceIdYearly: getEnv('VITE_STRIPE_PRICE_UNIVERSE_BUNDLE_YEARLY'),
    features: ['Unbegrenzte Credits', 'Alle FinTech Apps', 'Unbegrenzt KI-Nachrichten', 'Priority Support'],
  },
}
