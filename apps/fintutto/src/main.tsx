...
registerServiceWorker('/sw.js', {
  onReady: () => console.log('[Fintutto] Service Worker aktiv'),
  onUpdate: () => console.log('[Fintutto] Update verfügbar'),
  onOffline: () => console.log('[Fintutto] Offline-Modus'),
  onOnline: () => console.log('[Fintutto] Wieder online'),
})
