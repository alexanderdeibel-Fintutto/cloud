...
registerServiceWorker('/sw.js', {
  onReady: () => console.log('[ZählerApp] Service Worker aktiv'),
  onUpdate: () => console.log('[ZählerApp] Update verfügbar'),
  onOffline: () => console.log('[ZählerApp] Offline-Modus'),
  onOnline: () => console.log('[ZählerApp] Wieder online'),
})
