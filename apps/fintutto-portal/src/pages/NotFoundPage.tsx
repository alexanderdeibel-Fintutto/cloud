...
import { Home, ArrowLeft, Calculator, Shield, FileText } from 'lucide-react'
import { useDocumentTitle } from '@fintutto/shared'
import { Button } from '../components/ui/button'

const suggestions = [
  { title: 'Rechner', description: 'Kaution, Rendite, Nebenkosten & mehr', href: '/rechner', icon: Calculator },
  { title: 'Checker', description: 'Mietpreisbremse, Kuendigung & mehr', href: '/checker', icon: Shield },
  { title: 'Formulare', description: 'Mietvertrag, Uebergabe & mehr', href: '/formulare', icon: FileText },
]
