...
import { useProperties, type PropertyOption } from '@/hooks/useProperties'
...
/**
 * Dropdown that lets logged-in users pick one of their Vermietify buildings/units
 * to auto-fill Rechner & Formulare forms with real data.
 * Shows nothing if the user is not logged in or has no properties.
 */
