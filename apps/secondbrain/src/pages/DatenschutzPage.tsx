        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">c) Bei Upload von Dokumenten</h3>
                <p className="text-muted-foreground">
                  Wenn Sie Dokumente hochladen, werden diese verschluesselt in unserer Datenbank gespeichert. Die KI-Analyse (OCR, Zusammenfassung, Kategorisierung) erfolgt automatisch. Die Dokumente sind nur fuer Sie zugaenglich. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">d) Bei Nutzung des KI-Chats</h3>
                <p className="text-muted-foreground">
                  Wenn Sie den KI-Chat nutzen, werden Ihre Fragen zusammen mit relevanten Dokumenteninhalten an einen KI-Dienst uebermittelt. Es werden nur die fuer die Beantwortung notwendigen Daten uebertragen. Chatverlaeufe koennen jederzeit geloescht werden. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">e) Bei Nutzung der OCR-Funktion</h3>
                <p className="text-muted-foreground">
                  Hochgeladene Bilder und PDFs werden fuer die Texterkennung (OCR) verarbeitet. Der erkannte Text wird mit dem Dokument gespeichert und ist ueber die Suche auffindbar. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong className="text-foreground">Anthropic / OpenAI</strong> &ndash; KI-Analyse, OCR und Chat-Funktionen</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">8. Loeschung von Dokumenten</h2>
            <p className="text-muted-foreground">
              Sie koennen Ihre hochgeladenen Dokumente jederzeit selbststaendig loeschen. Nach der Loeschung werden alle zugehoerigen Daten (Dokument, OCR-Text, Zusammenfassung, Chat-Referenzen) unwiderruflich entfernt.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4">9. Recht auf Beschwerde bei der Aufsichtsbehoerde</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">10. Aenderung der Datenschutzerklaerung</h2>
            <p className="text-muted-foreground">
