      ...
      <div className="container py-12 max-w-4xl">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-xl p-6">
            ...
            <p className="text-muted-foreground">
              SecondBrain ist ein Dokumentenmanagement-Tool. Die KI-gestuetzten Analysen und Zusammenfassungen dienen der Organisation und Verwaltung Ihrer Dokumente. Sie ersetzen nicht die fachliche Pruefung der Dokumenteninhalte durch qualifizierte Fachpersonen.
            </p>
          </section>
