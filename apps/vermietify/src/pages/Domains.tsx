...
export function Domains() {
  ...
  const handleAddDomain = async () => {
    ...
    try {
      ...
      toast.success("Domain hinzugefügt", { description: newDomain.label });
  ...
  const handleDelete = async (e: React.MouseEvent, id: string, label: string) => {
    ...
    try {
      ...
      toast.success("Gelöscht", { description: label });
    } catch (e: any) {
      toast.error("Fehler", { description: e.message });
    }
  };
          ...
          <Button
            ...
            onClick={() => {
              checkAll.mutate(undefined, {
                ...
                onError: (e) => toast.error("Fehler beim Prüfen", { description: e.message }),
              });
            }}
          >
