...
registerServiceWorker('/sw.js', {
  onReady: () => console.log('[Mieter-Portal] Service Worker aktiv'),
  onUpdate: () => console.log('[Mieter-Portal] Update verfuegbar'),
  onOffline: () => console.log('[Mieter-Portal] Offline-Modus'),
  onOnline: () => console.log('[Mieter-Portal] Wieder online'),
})
