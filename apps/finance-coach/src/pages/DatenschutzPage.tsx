        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">c) Bei Nutzung der Finanzfunktionen</h3>
                <p className="text-muted-foreground">
                  Wenn Sie Budget-Kategorien, Sparziele oder Transaktionen anlegen, speichern wir diese Daten in unserer Datenbank. Diese Daten sind fuer die Bereitstellung der Finanzplanungsfunktionen erforderlich. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">d) Bei Nutzung der KI-Insights</h3>
                <p className="text-muted-foreground">
                  Wenn Sie die KI-Insights nutzen, werden relevante Finanzdaten anonymisiert an einen KI-Dienst uebermittelt. Es werden nur die fuer die Analyse notwendigen Daten uebertragen. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong className="text-foreground">Anthropic / OpenAI</strong> &ndash; KI-Insights und Analyse-Funktionen</li>
            </ul>
          </section>
