      ...
      <div className="container py-12 max-w-4xl">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-xl p-6">
            ...
            <p className="text-muted-foreground">
              Finance Coach bietet keine individuelle Finanzberatung im Sinne des KWG oder WpHG. Die KI-gestuetzten Analysen und Insights dienen ausschliesslich der allgemeinen Information und Finanzplanung und ersetzen nicht die Beratung durch einen zugelassenen Finanzberater.
            </p>
          </section>
