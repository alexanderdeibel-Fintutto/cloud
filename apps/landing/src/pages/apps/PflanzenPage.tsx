...
const FEATURES = [
  ...
  { icon: Star, title: 'Gieß-Erinnerungen', desc: 'Automatische Erinnerungen, wann welche Pflanze gegossen werden muss.' },
  { icon: Brain, title: 'KI-Diagnose', desc: 'Fotografiere eine kranke Pflanze — die KI erkennt das Problem und schlägt Lösungen vor.' },
  { icon: Zap, title: 'Saisonaler Kalender', desc: 'Wann umtopfen, düngen, zurückschneiden? Der Kalender erinnert dich.' },
  { icon: TrendingUp, title: 'Wachstums-Tagebuch', desc: 'Dokumentiere das Wachstum deiner Pflanzen mit Fotos und Notizen.' },
  { icon: Shield, title: 'Pflanzen-Community', desc: 'Tausche Tipps mit anderen Pflanzenliebhabern aus.' },
]
...
export function PflanzenPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20 pt-20 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Behalte alle deine Zimmerpflanzen im Blick — Gießkalender, Pflegetipps und Erinnerungen, damit deine Pflanzen immer gesund bleiben.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4">
            ...
            <Link
              to="/preise"
              className="w-full sm:w-auto border border-slate-300 hover:border-green-400 text-slate-700 font-semibold px-8 py-3.5 rounded-xl transition-colors text-base flex items-center justify-center gap-2"
            >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Was Pflanzen-Manager für dich tut</h2>
