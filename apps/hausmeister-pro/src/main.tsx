...
registerServiceWorker('/sw.js', {
  onReady: () => console.log('[HausmeisterPro] Service Worker aktiv'),
  onUpdate: () => console.log('[HausmeisterPro] Update verfuegbar'),
  onOffline: () => console.log('[HausmeisterPro] Offline-Modus'),
  onOnline: () => console.log('[HausmeisterPro] Wieder online'),
})
