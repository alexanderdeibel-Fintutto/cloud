      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Fintutto Admin - Domain & Website Management
          </p>
        </div>
        <Button
          variant="outline"
        ...
        >
          ...
          {checkAll.isPending ? 'Prüfe...' : 'Alle Domains prüfen'}
        </Button>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {stats?.setupComplete ?? 0} fertig eingerichtet
              </p>
            </CardContent>
          </Card>
          <Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Direkt zu den wichtigsten Bereichen</CardDescription>
          </CardHeader>
