    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl gradient-fitness mb-3">
            <Dumbbell className="h-7 w-7 text-white" />
          </div>
          <h1 className="text-2xl font-bold">
            Fit<span className="gradient-text-fitness">Tutto</span>
          </h1>
          <p className="text-sm text-muted-foreground mt-1">Dein KI-Personal Trainer</p>
        </div>

        {referralCode && (
          <div className="mb-4 p-3 rounded-lg bg-primary/5 border border-primary/20 text-center">
            <p className="text-sm text-primary font-medium">
              Du wurdest eingeladen! Registriere dich und erhalte Bonus-Credits.
            </p>
          </div>
        )}
            ...
            <Tabs value={tab} onValueChange={v => setTab(v as 'login' | 'register')}>
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full" variant="fitness" disabled={loading}>
        ...
        <p className="text-xs text-center text-muted-foreground mt-6">
          Teil des <a href="https://portal.fintutto.cloud" className="text-primary hover:underline">Fintutto-Ökosystems</a>.
