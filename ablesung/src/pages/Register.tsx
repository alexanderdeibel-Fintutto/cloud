        ...
        >
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-11 h-12 rounded-xl border-border/50 bg-card/80 text-foreground focus:bg-card focus:border-primary/50 focus:ring-2 focus:ring-primary/30 transition-all"
              required
            />
          </div>
        </motion.div>
