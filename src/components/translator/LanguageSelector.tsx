          ...
          <div className="overflow-y-auto flex-1">
            {filtered.map(lang => (
              ...
              >
                ...
                {lang.code === value && <div className="h-2 w-2 rounded-full bg-primary" />}
              </button>
            ))}
            {filtered.length === 0 && (
              <div className="px-3 py-4 text-sm text-muted-foreground text-center">Keine Sprache gefunden</div>
            )}
          </div>
        </div>
      )}
