...
import { Home, ArrowLeft, Shield, TrendingUp, Receipt, Calculator, FileText } from 'lucide-react'
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <div className="border-t pt-8 mt-8">
          <p className="text-sm font-medium text-muted-foreground mb-4">Beliebte Checker:</p>
