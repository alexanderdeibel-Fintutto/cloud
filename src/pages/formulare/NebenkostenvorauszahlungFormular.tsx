...
import FormularLayout from '@/components/formulare/FormularLayout'
...
export default function NebenkostenvorauszahlungFormular() {
  ...
  return (
    <FormularLayout
      title="Nebenkostenvorauszahlung anpassen"
      subtitle="Schreiben zur Anpassung der Nebenkostenvorauszahlung nach §560 BGB"
      steps={['Parteien', 'Kosten', 'Begründung', 'Schreiben']}
      currentStep={step}
